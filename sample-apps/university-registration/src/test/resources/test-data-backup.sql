-- PostgreSQL 테스트용 기본 데이터
-- KubeDB Monitor Agent PostgreSQL 호환성 테스트를 위한 데이터셋

-- 테이블 생성 (JPA가 생성하기 전에 필요한 경우를 대비)
...
-- 학과 데이터
INSERT INTO departments (department_id, department_name, code, created_at) VALUES 
(1, '컴퓨터과학과', 'CS', NOW()),
(2, '전자공학과', 'EE', NOW()),
(3, '수학과', 'MATH', NOW());

-- 학기 데이터
INSERT INTO semesters (semester_id, semester_name, is_current, created_at) VALUES 
(1, '2024-1', true, NOW()),
(2, '2024-2', false, NOW());
...
-- 기본 ASCII 문자
('CS101', 'Database Systems', 'Prof. Kim', 3, 30, 25, 1, 1, 'E101', '월1,수1', true, 'HIGH', NOW()),
('CS102', 'Data Structures', 'Prof. Lee', 3, 35, 20, 1, 1, 'E102', '화2,목2', true, 'MEDIUM', NOW()),

-- 한글 문자 (bytea 타입 캐스팅 문제 테스트)
('CS201', '데이터베이스설계', '김교수', 3, 25, 23, 1, 1, 'E201', '월3,수3', true, 'HIGH', NOW()),
('EE101', '전자회로', '이교수', 3, 40, 15, 2, 1, 'F101', '화1,목1', true, 'LOW', NOW()),

-- 특수문자 포함 (LOWER 함수 테스트)
('MATH101', 'Calculus I & II', 'Prof. Park-Smith', 4, 50, 45, 3, 1, 'M101', '월2,수2,금2', true, 'HIGH', NOW()),
('CS301', 'AI/ML Introduction', 'Dr. O''Connor', 3, 20, 18, 1, 1, 'E301', '화3,목3', true, 'MEDIUM', NOW());
